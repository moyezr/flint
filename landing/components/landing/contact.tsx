...
export function Contact() {
  return (
    <section className="bg-deep py-[138px] text-center text-paper max-[520px]:py-[98px]" aria-labelledby="contact-title">
      <div className="relative z-10 mx-auto w-[min(100%-48px,880px)] max-[840px]:w-[min(100%-36px,880px)] max-[520px]:w-[min(100%-28px,880px)]">
        <SectionHeading eyebrow="MAKE ROOM FOR THE THOUGHT" titleId="contact-title" title="Something Flint should do better?" />
        ...
        <p className="mt-[26px] text-[17px] leading-[1.6] text-demo-muted max-[520px]:text-base">Beta feedback, questions, and app-specific problems go directly to Moyez.</p>
      </div>
    </section>
  );
}
